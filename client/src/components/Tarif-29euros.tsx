...
const Tarif29 = () => {
  return (
    <div className="tarif-29">
      ...
      <p>Si vous bénéficiez du tarif à 29€ l’heure de main d ‘œuvre, il vous faudra tout d’abord prendre contact avec nos services pour fixer un rendez-vous pour un diagnostic du véhicule.</p>
      ...
      <ul>
        <li>
          ...
          <ul>
            <li>Avis de situation (attestation de stage, de formation, de recherche d’emploi…)</li>
